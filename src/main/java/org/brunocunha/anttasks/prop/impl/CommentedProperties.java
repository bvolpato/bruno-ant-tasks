 ...
 */
package org.brunocunha.anttasks.prop.impl;
...
public class CommentedProperties extends java.util.Properties {
	 ...
	 * @param key
	 *            - true if str the key is formatted, false if the value is
	 *            formatted
	 */
	 ...
	 * 
	 * @param line
	 *            The string to add to the end, make sure this is a comment or a
	 *            'whitespace' line.
	 */
